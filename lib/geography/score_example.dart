...
class ScoreExample extends StatefulWidget {
  final Widget child;

  ScoreExample({Key key, this.child}) : super(key: key);

  _ScoreExample createState() => _ScoreExample();
}

class _ScoreExample extends State<ScoreExample> {
